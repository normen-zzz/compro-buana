...
class Galeri_model extends CI_Model
{
	...
	// Listing data
	public function showGaleriByCategory($id_kategori_galeri)
	{
		$this->db->select('galeri.*, kategori_galeri.nama_kategori_galeri, users.nama');
		$this->db->from('galeri');
		// Join dg 2 tabel
		...
		$this->db->join('users', 'users.id_user = galeri.id_user', 'LEFT');
		// End join
		$this->db->where('galeri.id_kategori_galeri', $id_kategori_galeri);
	...
	public function showCategoryGaleryByYear($year)
	{
		...
		$this->db->join('users', 'users.id_user = galeri.id_user', 'LEFT');
		// End join
		$this->db->where('YEAR(`tanggal_publish`)', $year);
	...
	// Listing data
	public function tahun_galeri()
	{
		$this->db->select('YEAR(`tanggal_publish`) AS year');
		$this->db->from('galeri');
		$this->db->group_by('YEAR(`tanggal_publish`)');
		$this->db->order_by('YEAR(`tanggal_publish`)', 'DESC');
