...
<div class="row">
  ...
  <div class="col-md-3">
    ...
    <div class="form-group">
      ...
      <select name="jenis_berita" class="form-control" <?php if ($berita->jenis_berita == "Profil") { ?> readonly <?php } ?>>

        <?php if ($berita->jenis_berita == "Profil") { ?>
          <option value="Profil" <?php if ($berita->jenis_berita == "Profil") {
                                    echo "selected";
                                  } ?>>Profil</option>
        <?php } else { ?>
          <option value="Berita">Berita</option>
          <option value="Produk" <?php if ($berita->jenis_berita == "Produk") {
                                    echo "selected";
                                  } ?>>Produk</option>
        <?php } ?>
      </select>
  ...
  <div class="col-md-12">
    ...
    <div class="form-group">
      ...
      <input type="url" name="link" class="form-control" placeholder="http://website.com" value="<?php echo $berita->link ?>">
    </div>
