...
<div class="row">
  ...
  <div class="col-md-8">
    ...
    <div class="form-group form-group-lg">
      <label>Judul berita/profil/produk</label>
      <input type="text" name="judul_berita" class="form-control" placeholder="Judul berita/profil/produk" required="required" value="<?php echo set_value('judul_berita') ?>">
    </div>
  ...
  <div class="col-md-4">
    ...
    <div class="form-group form-group-lg">
      <label>Icon berita/profil/produk</label>
  ...
  <div class="col-md-12">
    ...
    <div class="form-group">
      ...
      <input type="url" name="link" class="form-control" placeholder="http://website.com" value="<?php echo set_value('link') ?>">
    </div>
