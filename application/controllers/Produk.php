...
class Produk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'produkall'            => $this->Produk_model->produk($config['per_page'], $page),
            'kategoriProduk'    => $this->Produk_model->categoryByProduk($config['per_page'], $page),
            'popup'                => $popup,
            'galeri'            => $galeri,
            'video'                => $video,
    ...
    public function detail($slug)
    {
        ...
        // Berita dan paginasi
        $this->load->library('pagination');
        $config['base_url']         = base_url() . 'Produk/detail/';
        $config['total_rows']         = count($this->berita_model->total());
        $config['use_page_numbers'] = TRUE;
        $config['num_links']         = 5;
        $config['uri_segment']         = 3;
        ...
        $data = array(
            ...
            'pagin'             => $this->pagination->create_links(),
            // 'berita'            => $berita,
            'produk'            => $this->Produk_model->produkBySlug($slug),
            'popup'                => $popup,
            'galeri'            => $galeri,
            'video'                => $video,
            'kategori_galeri'    => $kategori_galeri,
